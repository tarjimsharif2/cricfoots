...
const PointsTable = ({ tournamentId, tournamentName, compact = false, syncTime, dailySyncEnabled = false, onCompleteSyncEnabled = false }: PointsTableProps) => {
